...
export const PROJECTS = [
  ...
  },
  {
    ...
    tagline: "Azure DevOps activity simulator — Node.js tool to seed realistic, multi-user Pull Request activity in Azure DevOps",
    category: "devops",
    status: "active",
    isCluster: false,
    clusterMembers: null,
    ...
    screenshots: null,
    links: [
      { label: "GitHub", url: "https://github.com/oddessentials/ado-git-repo-seeder", primary: true },
  ...
  },
  {
    ...
    tagline: "Admin-approved social media posts — Facebook & X Social Media post creator with admin approval",
    ...
    screenshots: null,
    links: [
      { label: "GitHub", url: "https://github.com/oddessentials/socialmedia-syndicator", primary: true },
      { label: "Website", url: "https://oddessentials.com", primary: false },
    ],
  },
  {
...
export const CONSTELLATION_ZONES = [
  ...
  },
  {
    ...
    scrollStart: 0.33,
    scrollEnd: 0.66,
    projectIds: ["odd-map", "odd-fintech", "socialmedia-syndicator", "coney-island", "repo-standards"],
    nebulaHue: "amber",
